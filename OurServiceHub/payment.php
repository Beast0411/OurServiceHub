...
<body>
    ...
    <div class="appointment_container">
        ...
        <form class="input_all_container">
            ...
            <div class="per_input_container1">
                <div>
            ...
            <!-- <div class="promo_code_service_charge_container"> -->

            <div class="per_input_container3">
                <p>Discounts of promo code</p>
            ...
            <div class="per_input_container4">
                <a href="bookAppointment.php">back</a>

                <a href="scheduleAppointment.php">confirm & book service</a>
            </div>
