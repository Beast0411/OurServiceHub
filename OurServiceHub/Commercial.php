    ...
    <section class="electrical-section clearfix">
        <div class="row">
            <div class="col span_1_of_2 electrical-wrapper">
                ...
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
                <span class="rating">243 ratings</span>
            ...
            <div class="col span_1_of_2 service-wrapper">
                <h5>SubService of Commercial-cleaning Service</h5>
                <ul>
                    <li><a class="buzz" href="#">Office cleaning</a></li>
                    <li><a class="buzz" href="#">warehouse Cleaning</a></li>
                    <li><a class="buzz" href="#">EIndustrial-area cleaning</a></li>
                    <!--<li><a class="buzz" href="#">Exhaust Fan Servicing</a></li>
                    <li><a class="buzz" href="#">Switch Servicing</a></li>
                    <li><a class="buzz" href="#">Tube Light Servicing</a></li>
                    <li><a class="buzz" href="#">Wall Fan Servicing</a></li> -->
                </ul>
                <a href="bookAppointment.php"><button class="button1">Book now</button></a>
            </div>
        </div>
    </section>
