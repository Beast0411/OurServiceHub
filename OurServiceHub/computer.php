    ...
    <section class="computer-section clearfix">
        <div class="row">
            ...
            <div class="col span_1_of_2 service-wrapper">
                ...
                <ul>
                    <li><a class="buzz" href="#">Computer Servicing Inspection</a></li>
                    <li><a class="buzz" href="#">OS & Software Installation</a></li>
                </ul>
